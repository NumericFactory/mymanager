                      ...
                      <form id="usereditstep1" method="post" action="{{action('UsersController@saveCompanyDataStepOne', ['id'=> Auth::user()->id])}}" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate="" class="form-horizontal group-border-dashed">
                        ...
                        <div class="form-group xs-pt-0">
                          ...
                          <div class="col-lg-5 col-md-6 col-sm-4">
                            <div class="xs-pt-10">
                             ...
                             <input value="{{ $user->company->address->formatted_address or old('formatted_address') }}" id="autocomplete" class="form-control" placeholder="Adresse de votre entreprise" onFocus="geolocate()" type="text">
                            </div>
                            <div class="errors"></div>
                          </div>
                        </div>
                        ...
                        <div class="form-group xs-pt-0">
                          <div class="col-sm-3 col-lg-3 col-md-4">
                           ...
                           <div class="col-lg-5 col-md-6 col-sm-4">
                            <div class="xs-pt-10">
                              <input value="{{ $user->company->address->complementaddress or old('complementaddress') }}" name="complementaddress" type="text" placeholder="" class="form-control">
                            </div>
                          </div>
                        </div>

                        <input value="{{ $user->company->address->formatted_address or old('formatted_address') }}" name="formatted_address" type="hidden">
                        ...
                        <div class="form-group xs-pt-0 hidden">
                          ...
                          <div class="col-lg-5 col-md-6 col-sm-4">
                            <div class="xs-pt-10">
                              <input name="address" type="text" placeholder="" class="form-control" value="{{ $user->company->address->address or old('address') }}">
                            </div>
                            <div class="errors"></div>
                          </div>
                        </div>
                        ...
                        <div class="form-group xs-pt-0 hidden">
                          ...
                          <div class="col-lg-5 col-md-6 col-sm-4">
                            <div class="xs-pt-10">
                              <input name="cp" data-mask="cp" type="text" placeholder="ex: 75009" class="form-control" value="{{ $user->company->address->cp or old('cp') }}">
                            </div>
                            <div class="errors"></div>
                          </div>
                        </div>
                        <div class="form-group xs-pt-0 hidden">
                          ...
                          <div class="col-lg-5 col-md-6 col-sm-4">
                            <div class="xs-pt-10">
                              <input name="city" type="text" placeholder="" class="form-control" value="{{ $user->company->address->city or old('city') }}">
                            </div>
                            <div class="errors"></div>
                          </div>
                        </div>
                        <div class="form-group xs-pt-0 hidden">
                          ...
                          <input name="country" type="text" placeholder="" class="form-control hidden" value="{{ $user->company->address->country or old('country') }}">
                        </div>
                        ...
                        <form id="chequeform" action="{{action('UsersController@saveCompanyCheque', ['id'=> Auth::user()->id])}}">
                          ...
                          <div style="margin-bottom:0px" class="form-group">
                            <label style="margin-bottom:4px">
                              ...
                              {{$user->company->address->cp}} {{$user->company->address->city}}
                              </h4>
                            </label>
                          </div>
                          <br>
                         {{--  <div class="form-group">
                            <input value="{{$user->company->address->address}} {{$user->company->address->cp}} {{$user->company->address->city}}" type="text" placeholder="Ici votre adresse" class="form-control">
